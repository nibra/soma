...
def test_loads_agents_and_subscribes():
    ...
    bus.publish("email", Message(source_type="email", source_id="t1", subject="Test", content="", timestamp="now", metadata={}))
    bus.publish("random", Message(source_type="test", source_id="t2", subject="Unmatched", content="", timestamp="now", metadata={}))
    ...
    bus.publish("email", Message(source_type="email", source_id="t3", subject="GitHub test", content="", timestamp="now", metadata={}))
    bus.publish("random", Message(source_type="test", source_id="t4", subject="Unclassified", content="", timestamp="now", metadata={}))
